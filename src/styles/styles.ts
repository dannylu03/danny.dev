...
const Styles = createGlobalStyle`
  ...
  * {
  ...
  h1,h2,h3,h4,h5,h6{
    background: linear-gradient(121.57deg, ${(props) =>
      props.theme.colors.headingFirstGradientColor} 18.77%, ${(props) =>
  props.theme.colors.accent1} 60.15%);
  ...
  button{
    ...
    background-image: linear-gradient(270deg,${(props) =>
      props.theme.colors.background2} 0%, ${(props) =>
  props.theme.colors.accent1} 100%);
    color: #fefefe;
    border: 0;
    outline: 0;
    cursor: pointer;
    ...
    &:hover {
      background-image: linear-gradient(270deg, ${(props) =>
        props.theme.colors.accent1} 0%, ${(props) =>
  props.theme.colors.background2} 100%);
    }
  }
  .ReactModal__Overlay{
